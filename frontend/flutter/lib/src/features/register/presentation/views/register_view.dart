                ...
                children: [
                  ...
                  (snapshot.data!.isNotEmpty) ?
                    DropdownPickerField(
                      ...
                      initialValue: snapshot.data![0].code,
                      items: snapshot.data!.map((e) => e.code).toList(),
                      onChanged: (value) {
                        prefCoinType = value;
                      }
                    ) :
                  ...
                  Container(
                    ...
                    child:  SimpleTextButton(
                      ...
                      onPressed: () async {
                        ...
                        registerFormState.setPrefCoinType(prefCoinType ?? snapshot.data![0].code);
                        ...
                        if (registerStateNotifierProvider is AuthStateSuccess) {
                          // Retry login
                          if (!mounted) return;
                          context.go("/auth");
                        }
                      }, 
                      child: registerStateNotifierProvider is AuthStateLoading ?
