...
| APP_MINIO_STATIC_BUCKET_NAME | Minio static bucket name. Default: ***balhom-static-bucket***    |
| APP_MINIO_MEDIA_BUCKET_NAME  | Minio media bucket name. Default: ***balhom-media-bucket***      |
