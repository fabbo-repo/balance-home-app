...
class CoinPermissionsTests(APITestCase):
    def setUp(self):
        ...
        self.currency_exchange_code_url = reverse("currency_exchange_code", args=["EUR"])
        ...
        self.credentials1 = {"email": "email1@test.com", "password": "password1@212"}
        self.credentials2 = {"email": "email2@test.com", "password": "password1@212"}
        # User creation
    ...
    def test_currency_type_get_url(self):
        ...
        response = test_utils.get(
            self.client, self.currency_type_list_url + "/" + str(self.currency_type.code)
        )
