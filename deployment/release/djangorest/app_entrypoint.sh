...
# Create superuser
if  python3 manage.py createsuperuser --no-input; then
...
# App commands
python3 manage.py balance_schedule_setup
python3 manage.py create_balance_models
python3 manage.py coin_schedule_setup
python3 manage.py create_coin_models
